const MenuData = [
  ...
  "김치찜", "코다리조림", "묵은지찜", "돼지갈비찜", "만둣국",
  "갈비탕", "도가니수육", "꼬리찜", "아롱사태수육", "수육백반", "곱창전골",
  "대창전골", "막창전골", "양곱창", "소갈비찜", "돼지김치찜", "묵은지김치찜",
  ...
  "갈비만두", "군만두", "짜파게티", "라볶이",
  "어묵탕", "소고기무국", "미역국", "황태국", "북엇국", "시금치국",
  "근대국", "토란국", "배추된장국", "아욱된장국", "냉이된장국", "달래된장국",
  "쑥된장국", "시래기된장국", "된장국", "콩나물국", "미역냉국", "오이냉국",
  "김칫국", "시래기국", "북엇국", "황태국", "떡만둣국", "짜장라면",
  "비빔면", "컵라면", "봉지라면",
  ...
  "해물파스타", "리조또", "오징어먹물리조또", "버섯리조또", "새우리조또", "김치리조또",
  "만두전골", "버섯전골", "소불고기전골", "곱창전골", "닭한마리칼국수", "닭곰탕",
  "육개장칼국수", "짬뽕밥", "볶음짬뽕밥", "간짜장", "삼선짜장", "쟁반짬뽕",
  "냉짬뽕", "차돌짬뽕", "백짬뽕", "중화냉면", "중화비빔밥", "마라샹궈",
  "양갈비", "양다리구이", "족발볶음", "보쌈김치찜", "감자옹심이", "메밀전병",
  "배추전", "동태전", "육전", "굴전", "호박전", "버섯전",
  "꼬치구이", "닭꼬치", "삼겹살꼬치", "염통꼬치", "닭발볶음", "닭똥집볶음",
  "오돌뼈볶음", "돼지껍데기볶음", "막창볶음", "곱창볶음", "대창볶음", "양볶음",
  "쭈꾸미삼겹살볶음", "낙곱새", "두부김치", "골뱅이소면", "번데기탕", "과메기무침",
  "홍어삼합", "해물찜닭", "치즈찜닭", "간장찜닭", "매콤찜닭", "아귀찜",
  "해물탕", "아귀탕", "동태찌개", "갈치찌개", "고등어찌개", "꽁치찌개",
  "부대찌개라면", "짬뽕라면", "해물라면", "파김치라면", "콩나물라면", "떡만두라면",
  "오징어짬뽕", "나가사끼짬뽕", "마제소바", "츠케멘", "아부라소바", "소유라멘",
  "미소라멘", "시오라멘", "카레라이스", "새우카레", "돈까스카레", "아비가일카레",
  "코코이찌방야카레", "스프카레", "냉모밀", "온모밀", "판모밀", "비빔모밀",
  "알리오올리오파스타", "봉골레파스타", "까르보나라파스타", "새우크림파스타", "게살크림파스타", "로제파스타",
  "해산물토마토파스타", "치킨토마토파스타", "바질페스토파스타", "라자냐", "뇨끼", "아란치니",
  "피자", "마르게리따피자", "페퍼로니피자", "불고기피자", "콤비네이션피자", "고구마피자",
  "쉬림프골드피자", "포테이토피자", "시카고피자", "디트로이트피자", "칼조네", "포카치아",
  "감바스", "스페인오믈렛", "빠에야", "핀초", "타파스", "굴라쉬",
  "슈니첼", "족발덮밥", "보쌈정식", "불고기정식", "갈비정식", "백반"
];
